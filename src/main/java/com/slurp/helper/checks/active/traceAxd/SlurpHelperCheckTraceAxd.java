...
public class SlurpHelperCheckTraceAxd extends AbstractSlurpHelperActiveCheck {
    private String data = null;

    SlurpHelperCheckTraceAxd(int id, SlurpHelperAnalyzedRequestResponse analyzed, AbstractSlurpHelperCheck parent) {
